...
public class ForecastConditionAdapter {
    ...
    @ToJson
    public ForecastConditionJson forecastConditionToJson(ForecastCondition forecastCondition) {
     ...
     */
    @AutoValue
    abstract static class ForecastConditionJson {
        ...
        @Json(name = "FCTTIME")
        abstract FctTime getFcTTime();

        @Json(name = "temp")
        abstract Temperature getTemperature();
    }

    @AutoValue
    abstract static class FctTime {
    ...
    @AutoValue
    abstract static class Temperature {
